...
public class CommandNavMeshMove : OwnerState<CommandsReceiverEntity>
{
    public CommandNavMeshMove(CommandsReceiverEntity owner, Vector3 destination) : base(owner)
    {
